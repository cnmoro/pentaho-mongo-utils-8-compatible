...
public class ConnectionStringMongoClientWrapper implements MongoClientWrapper {
  ...
  public List<String> getDatabaseNames() throws MongoDbException {
    try {
      return getMongo().listDatabaseNames().into(new ArrayList<String>());
    } catch ( Exception e ) {
      throw new MongoDbException( e );
    }
  }
  ...
  public List<MongoCredential> getCredentialList() {
    MongoCredential cred = new ConnectionString(connectionString).getCredential();
    return cred != null ? Arrays.asList(cred) : Collections.<MongoCredential>emptyList();
  }
